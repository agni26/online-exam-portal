				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-offset-1 text-center">
							<h1 class="hestia-title">Hello Company			</h1>			</div>
					</div>
				</div>
			</div>
		</header>
...
%>
	...
	<h3 style="text-align:center;">Welcome <%=c1 %> !</h3>
	<hr><br>
	<a href="candidate.html"><img src="search.jpg" title="Search Students" alt="Search Candidates" style="width:200px;height:200px;text-align: center;"><br>&emsp;&emsp;&emsp;Pick Up Students</a>&emsp;&emsp; 
	</div>
	<br><hr>
<%
}
