				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-offset-1 text-center">
							<h1 class="hestia-title">Renewal Requests		</h1>			</div>
					</div>
				</div>
			</div>
		</header>
...
<br><hr>
<form action="renewit.jsp" method="post">
<fieldset>
    <h3>Enter the Email of Student Whose Test Are To Be Renewed :</h3><br>
	Email ID : &ensp; <input type="email" name="id" size="10" required><br><br><p>&emsp;
	<input type="submit" value="Renew"> &emsp;
	<input type="reset">
	</fieldset>
</form>
<br><br><hr>
...
<%
	  if(p==0){
		%>
		<p style="text-align: center; font-size: 30; color: red; " >
		No Requests
		</p><br><hr>
		<%
	}
