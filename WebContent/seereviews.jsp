...
<body class="page-template-default page page-id-4 page-child parent-pageid-15 wp-custom-logo blog-post">
	...
	<nav class="navbar navbar-default navbar-fixed-top ">
		<div class="container">
			...
			<div id="main-navigation" class="collapse navbar-collapse"><ul id="menu-primary-menu" class="nav navbar-nav navbar-right"><li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-page-ancestor current-page-parent menu-item-25"><a title="Home" href="Index.html">Home</a></li>
			<li id="menu-item-26" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-26"><a title="Blog" href="blog.html">Blog</a></li>
...
<li id="menu-item-36" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-36"><a title="About Us" href="info.html">About Us</a></li>
...
ResultSet rss=stt.executeQuery("Select * from reviews");

while(rss.next()){


	Float r=rss.getFloat("rating");
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-offset-1 text-center">
							<h1 class="hestia-title"></h1>			</div>
							<div style="color: Red;" class="col-md-10 col-md-offset-1 text-center " >
...
<hr><br>
<p style="font-size: 55px; color: red; text-align: center;"> 
<%
for(int i=0; i<r;i++){
...
<br>
<p style="font-family: Lucida Handwriting; font-size: 25px; color: black; text-align: center;">

	<b>"  <%= c %>  "</b>

</p>
<p style="font-family:Arial; font-size: 18px; color: black; text-align: center;">
