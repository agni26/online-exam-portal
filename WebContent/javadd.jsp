...
<h1 style="text-align:center;">The Question Has Been Deleted</h1>
<hr><br>
<%
...
PreparedStatement ps=conn.prepareStatement("delete from java where number=?");
...
<a href="javad.jsp">Delete another Question From Java</a><br><br>
<a href="delete.html">Delete Question From other Language</a><br><br>
