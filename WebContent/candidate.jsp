				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-offset-1 text-center">
							<h1 class="hestia-title">Search Candidates		</h1>			</div>
					</div>
				</div>
			</div>
		</header>
...
String gen=request.getParameter("gendr");
String m1=request.getParameter("score");
...
if(gen.equalsIgnoreCase("any")){
	
	while(rs.next()){
		
		String Scourse=rs.getString("course");
		if(c.equalsIgnoreCase(Scourse)){System.out.println("in");
				String Squalification=rs.getString("qualifcation");
				if(q.equalsIgnoreCase(Squalification)){System.out.println("in quali");
					String Spass=rs.getString("pass");
					if(y.equalsIgnoreCase(Spass)){System.out.println("in year");
						int Smarks=rs.getInt("score");
						int m=Integer.parseInt(m1);
						int l1=(m-10);
						System.out.println("in");
						if((Smarks<=m)&&(Smarks>l1)){System.out.println("in marks");
							String wname=rs.getString("name");
							String wmobile=rs.getString("mobile");
	...
	if(c.equalsIgnoreCase(Scourse)){System.out.println("in");
		...
		if(gen.equalsIgnoreCase(Sg)){System.out.println("in gen");
			//String Sg=rs.getString("gender");
			String Squalification=rs.getString("qualifcation");
			if(q.equalsIgnoreCase(Squalification)){System.out.println("in quali");
				String Spass=rs.getString("pass");
